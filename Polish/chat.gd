...
"mika are you really so starved for content that youre making your own fans do it for you",
"is mimka preganta??",
"hi staff san",
...
"we could have had a 15 hour zatsu stream instead",
"mika I will literally donate 100 dollars to stop playing",
